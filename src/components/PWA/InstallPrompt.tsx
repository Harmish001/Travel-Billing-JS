  ...
  return (
    <Modal
      ...
      footer={[
        ...
        <Button key="install" type="primary" onClick={handleInstall} icon={<DownloadOutlined />}>
          Install App
        </Button>,
      ]}
    >
      <Space direction="vertical" style={{ width: '100%', textAlign: 'center' }}>
        ...
        <Text>
          Add Travel Billing to your home screen for faster access and improved experience.
        </Text>
      </Space>
    </Modal>
  );
